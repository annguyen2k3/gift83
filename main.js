...
function startScreen4() {
    return initScreen4(document.getElementById("screen-4"), () =>
        transitionTo(4, 3, () => startScreen3({ startAtGifts: true })),
    );
}
...
function startScreen5() {
    return initScreen5(document.getElementById("screen-5"), () =>
